...
public class PlatformHelper extends de.Keyle.MyPet.api.PlatformHelper {
    ...
    public static final Field dragonPartsField = ReflectionUtil.getField(ServerLevel.class, "dragonParts"); //Mojang Field: dragonParts
    ...
    public TagCompound entityToTag(Entity bukkitEntity) {
        ...
        if (entity instanceof net.minecraft.world.entity.LivingEntity) {
            ...
            Method b = ReflectionUtil.getMethod(entity.getClass(), "addAdditionalSaveData", CompoundTag.class);
            try {
