...
public class EntityRegistry extends de.Keyle.MyPet.api.entity.EntityRegistry {
	...
	public void registerEntityTypes() {
		...
		Field frozenDoBe = ReflectionUtil.getField(MappedRegistry.class,"frozen"); //frozen
		Field intrusiveHolderCacheField = ReflectionUtil.getField(MappedRegistry.class,"unregisteredIntrusiveHolders"); //intrusiveHolderCache or unregisteredIntrusiveHolders or intrusiveValueToEntry
		MethodHandle ENTITY_REGISTRY_SETTER = ReflectionUtil.createStaticFinalSetter(BuiltInRegistries.class, "ENTITY_TYPE"); //ENTITY_TYPE
