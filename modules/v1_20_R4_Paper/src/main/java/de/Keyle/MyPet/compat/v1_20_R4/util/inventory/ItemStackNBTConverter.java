...
import de.Keyle.MyPet.compat.v1_20_R4.NBTHelper;
...
public class ItemStackNBTConverter {
	...
	private static final Field TAG_LIST_LIST = ReflectionUtil.getField(ListTag.class, "list"); //List-Field (or value)
